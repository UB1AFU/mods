...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "Guess he's not ready for a shave yet.",
			GENERIC = "Guess I can't shave that ugly thing.",
			NOBITS = "The weird creature is bald.",
		},
		STORE =
		{
			GENERIC = "Is it full of Sake?",
			NOTALLOWED = "Nope.",
			INUSE = "I could nap while I wait my turn.",
		},
		RUMMAGE =
		{	
	...
	ANNOUNCE_ADVENTUREFAIL = "It's not over...",
	ANNOUNCE_BEES = "Dumb Bees.",
	ANNOUNCE_BOOMERANG = "...I prefer my swords.",
	ANNOUNCE_CHARLIE = "What was that?!",
	ANNOUNCE_CHARLIE_ATTACK = "OW! Something bit me!",
	ANNOUNCE_COLD = "Im...not...Cold...",
	ANNOUNCE_CRAFTING_FAIL = "Someone forgot to get all the ingredients.",
	ANNOUNCE_DEERCLOPS = "Something want to fight?",
	ANNOUNCE_DUSK = "Time for a nap.",
	ANNOUNCE_EAT =
	{
		GENERIC = "Not bad.",
		PAINFUL = "Wth is that ero-cook cooking...",
		SPOILED = "...",
		STALE = "...",
	},
	ANNOUNCE_ENTER_DARK = "Hey, could use some light.",
	ANNOUNCE_ENTER_LIGHT = "Least I can see again.",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "I feel so smart now!",
	ANNOUNCE_HOUNDS = "Looks like its time to fight.",
	ANNOUNCE_HUNGRY = "Could use some food.",
	ANNOUNCE_HUNT_BEAST_NEARBY = "Can't someone else hunt this...?",
	ANNOUNCE_HUNT_LOST_TRAIL = "Oh well, wanted to lift weights anyway.",
	ANNOUNCE_INV_FULL = "If it's not sake I'm not carrying it.",
	ANNOUNCE_KNOCKEDOUT = "What happened?",
	ANNOUNCE_LOWRESEARCH = "I didn't learn very much from that.",
	ANNOUNCE_MOSQUITOS = "Get out of my way Mosquitos.",
	ANNOUNCE_NODANGERSLEEP = "I should be more alert.",
	ANNOUNCE_NODAYSLEEP = "Guess I can't nap now.",
	ANNOUNCE_NODAYSLEEP_CAVE = "I'm not tired.",
	ANNOUNCE_NOHUNGERSLEEP = "Must eat before I sleep.",
	ANNOUNCE_NODANGERAFK = "No way am I running from this fight.",
	ANNOUNCE_NO_TRAP = "Can't I just slice it instead.",
	ANNOUNCE_PECKED = "Hey! Cut it out!",
	ANNOUNCE_QUAKE = "That doesn't sound good.",
	ANNOUNCE_RESEARCH = "Never stop learning!",
	ANNOUNCE_THORNS = "Dang these thorns.",
	ANNOUNCE_TORCH_OUT = "At the worst possible time too.",
	ANNOUNCE_TRAP_WENT_OFF = "Oops.",
	ANNOUNCE_UNIMPLEMENTED = "I don't think it's ready yet.",
	ANNOUNCE_WORMHOLE = "Wish I had walked instead.",
	ANNOUNCE_CANFIX = "\nI think I can fix this!",
	ANNOUNCE_ACCOMPLISHMENT = "One step closer to my ambitions.",
	ANNOUNCE_ACCOMPLISHMENT_DONE = "If only my friends could see me now...",	
	ANNOUNCE_BECOMEGHOST = "How did this happen...",
	ANNOUNCE_GHOSTDRAIN = "My humanity is about to start slipping away...",

	DESCRIBE_SAMECHARACTER = "What is going on?",
	...
	BATTLECRY =
	{
		...
		PREY = "Shishi Sonson!",
		SPIDER = "Santoryu!",
		SPIDER_WARRIOR = "Shishi Sonson!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "Maybe not right now...",
		PIG = "I'll let him go. This time.",
		PREY = "I'll let him get away.",
		SPIDER = "I didn't want to fight anyway.",
		SPIDER_WARRIOR = "I didn't want to fight anyway.",
	},
	DESCRIBE =
	{
        PLAYER =
        {
            GENERIC = "Who's %s anyway?",
		...
		AXE = "Couldn't I just use my swords?",
		BABYBEEFALO = "A baby creature thing.",
		BACKPACK = "It's for me to put my sake in.",
		BACONEGGS = "Flavored with Sake.",
		...
		{
			GENERIC = "Dumb bee.",
			HELD = "Should be careful.",
		},
		BEEBOX =
		{
			FULLHONEY = "Wish it made sake.",
			GENERIC = "Bees!",
			NOHONEY = "It's empty.",
		...
		BEEFALO =
		{
			FOLLOWER = "Why is he following.",
			GENERIC = "What a weird thing.",
			NAKED = "Well...",
			SLEEPING = "Least they like naps like me.",
		},
		BEEFALOHAT = "Why would I wear that...",
		BEEFALOWOOL = "Pretty warm stuff.",
		BEEHAT = "I don't need protection from Bees.",
		BEEHIVE = "Why can't they produce Sake.",
		BEEMINE = "It buzzes when I shake it.",
		BEEMINE_MAXWELL = "Bottled mosquito rage!",
		BERRIES = "A good snack I guess.",
		BERRIES_COOKED = "I don't think heat improved them.",
		BERRYBUSH =
		{
			BARREN = "Could use some poop.",
			GENERIC = "Red berries taste the best.",
			PICKED = "Maybe they'll grow back?",
		},
		BIRDCAGE =
		{
			GENERIC = "Someone else should put a bird in it.",
			OCCUPIED = "That's my bird!",
			SLEEPING = "Sleeping sounds like a good idea.",
		},
		...
		CAMPFIRE =
		{
			EMBERS = "Need a fire to keep watch.",
			GENERIC = "Time to bring out the Sake! ",
			HIGH = "Time to bring out the Sake! ",
			LOW = "Someone needs to put wood on the fire.",
			NORMAL = "Time to bring out the Sake! ",
			OUT = "Well...",
		},
		CANE = "It makes walking seem much easier!",
		CARROT = "Any food is fine by me.",
		CARROT_COOKED = "Mushy.",
		...
		COOKPOT =
		{
			COOKING_LONG = "Someone cook this food faster!",
			COOKING_SHORT = "Hope there's Sake to come with it.",
			DONE = "Hope there's Sake to come with it.",
			EMPTY = "Wish there were food.",
		},
		...
		DEERCLOPS = "Time for a fun fight.",
		...
		FARMPLOT =
		{
			GENERIC = "Why do I have to plant crops.",
			GROWING = "Could take a nap while I wait.",
			NEEDSFERTILIZER = "I think it needs to be fertilized.",
		},
		FEATHERHAT = "Can I take it off.",
		...
		FIREFLIES =
		{
			GENERIC = "Get out of my way bugs.",
		...
		GOLDNUGGET = "Usopp could probably build something with this.",
		GRASS =
		{
		...
		KILLERBEE =
		{
			GENERIC = "Killer Bee's dont scare me.",
			HELD = "This seems dangerous.",
		},
		KNIGHT = "Check it out!",
		KOALEFANT_SUMMER = "Lets feast.",
		KOALEFANT_WINTER = "Least feast!",
		KRAMPUS = "I won't let him take my sake!",
		...
		SPIDERQUEEN = "I could kill it easily.",
		SPIDER_WARRIOR =
		{
			DEAD = "Good riddance!",
		...
		TALLBIRD = "Don't come near unless you want to get sliced Tallbird.",
