...
function MakeMechType(data)
    ...
    return Prefab("common/mech_"..data.name, fn, assets, prefabs),
           Prefab("common/mech_"..data.name.."_item", itemfn, assets, {"wall_"..data.name, "mech_"..data.name.."_item_placer", "collapse_small"}),
           MakePlacer("common/mech_"..data.name.."_item_placer", "wall", "wall_"..data.name, "half", false, false, true, nil, nil, "eight")
end
