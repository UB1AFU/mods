...
function MakeLockedMechType(data)
    ...
    local assets =
    {
		...
		Asset("ATLAS", "images/inventoryimages/normal/locked_mech_"..data.name.."_item.xml"),
    }
    ...
    local function itemfn()
		...
		inst.components.inventoryitem.atlasname = "images/inventoryimages/normal/locked_mech_"..data.name.."_item.xml"
    ...
    return Prefab("common/locked_mech_"..data.name, fn, assets, prefabs),
           Prefab("common/locked_mech_"..data.name.."_item", itemfn, assets, {"wall_"..data.name, "locked_mech_"..data.name.."_item_placer", "collapse_small"}),
           MakePlacer("common/locked_mech_"..data.name.."_item_placer", "wall", "wall_"..data.name, "half", false, false, true, nil, nil, "eight")
end
