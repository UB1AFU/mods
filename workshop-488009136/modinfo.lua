...
name = "Archery Mod [DST Version]"
description = "Focusing on bringing more ranged weapons to the game. \nNow with FULL Controller Support! \nCheckout Apothecary Medicamento Mod which add a drug improving your Archer efficiency!"
author = "ZupaleX"
version = "1.2.161115"
...
configuration_options =
{
	...
	
	{
		name = "HitChanceBugs",
		label = "Bow Miss Tiny",
		hover = "蝴蝶和蜜蜂这样小目标的 miss 概率",
		options =
		{
			{description = "no", data = false, hover= "解除降低蝴蝶蜜蜂的命中率"},
			{description = "yes", data = true, hover= "蝴蝶和蜜蜂的命中率降低到 1%"},
		},
		default = true,
	},
	...
	
	{
		...
		label = "Mag. Bow recipe - Living Shafts",
		hover = "Amount of Living Shaftss required to craft the Magic Bow",
		options =
		{
			{description = "1", data = 1},
			{description = "2", data = 2},
